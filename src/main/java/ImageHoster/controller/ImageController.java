...
public class ImageController {
    ...
    public String showImage(@PathVariable("title") String title, @PathVariable Integer imageId, Model model) {
        Image image = imageService.getImageByTitle(imageId, title);
        List<Comment> comment = commentService.getCommentByImage(imageId, title);
